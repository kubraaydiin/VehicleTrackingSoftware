...
builder.Services.AddDbContext<VehicleContext>(item => item.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
builder.Services.AddTransient<VehicleOperations>();
